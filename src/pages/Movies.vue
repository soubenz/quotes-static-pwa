    ...
    <v-row>
      <v-col cols="12" sm="4" v-for="series in $page.allMovies.edges" :key="series.node.id">
        <v-card :to="getPageUrl(series.node.title)">
          ...
          <v-card-text>
            <v-img contain height="400px" :src="series.node.poster" :lazy-src="loading">
